Function Service-Check {
    ...
    Param(
        ...
        [ValidateSet('AD','Apache','Autodesk','Citrix XenApp','Connectwise Control Endpoint','Connectwise Control Server','Connectwise Manage','DHCP','DNS','Exchange','Hyper-V','IIS','Lighthouse','Microsoft Dynamics','MSSQL','MySQL','Perch Log Shipper','PostgreSQL','Print','ProjectWise','Quickbooks','Sentinel Licensing Server','SentinelOne','Sharepoint','Trimble','Umbrella','Veeam Agent','Veeam B&R','Windows Server','Windows Workstation')]
        [array]$Role
